...
const InputArea: React.FC<InputAreaProps> = ({ text, setText, onAnalyze, onFileUpload, isLoading }) => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-slate-800/60 via-slate-800/50 to-slate-900/60 p-8 rounded-2xl shadow-2xl border border-slate-700/50 backdrop-blur-md hover:border-amber-500/30 transition-all duration-500 group overflow-hidden">
      ...
      <div className="relative z-10">
        <label htmlFor="poem-input" className="flex items-center gap-3 text-xl font-bold text-slate-200 mb-4 group-hover:text-amber-400 transition-colors duration-300">
          <div className="flex items-center justify-center w-10 h-10 bg-gradient-to-br from-amber-500/20 to-orange-500/20 rounded-xl border border-amber-500/30 group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="relative">
          <textarea
            id="poem-input"
            rows={6}
            className="w-full bg-gradient-to-br from-slate-950/80 to-slate-900/80 border-2 border-slate-700/50 rounded-xl p-6 text-slate-100 font-kannada text-xl focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50 transition-all duration-300 resize-y shadow-inner placeholder:text-slate-600 hover:border-slate-600/70 backdrop-blur-sm"
          ...
          {text && (
            <div className="absolute bottom-3 right-3 bg-slate-800/90 backdrop-blur-sm px-3 py-1 rounded-lg border border-slate-700/50">
        ...
        <div className="mt-5 p-5 bg-gradient-to-r from-amber-900/20 via-orange-900/20 to-slate-900/40 rounded-xl border border-amber-500/20 flex items-start space-x-4 backdrop-blur-sm shadow-lg hover:border-amber-500/40 transition-all duration-300 group/tip">
            <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-amber-500/30 to-orange-500/30 rounded-lg flex items-center justify-center border border-amber-500/30 group-hover/tip:scale-110 transition-transform duration-300">
              <svg className="h-5 w-5 text-amber-400" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
              </svg>
            </div>
            <div>
              <p className="text-sm font-semibold text-amber-300 mb-1">NOTE </p>
              <p className="text-sm text-slate-300 leading-relaxed">
                You can upload <code className="bg-slate-800/70 text-amber-300 px-2 py-0.5 rounded-md font-mono text-xs border border-amber-500/20">.pdf</code>, <code className="bg-slate-800/70 text-amber-300 px-2 py-0.5 rounded-md font-mono text-xs border border-amber-500/20">.docx</code>, or <code className="bg-slate-800/70 text-amber-300 px-2 py-0.5 rounded-md font-mono text-xs border border-amber-500/20">.txt</code> files. Due to font encoding issues, Kannada text from PDFs may not extract correctly. If you get garbled text, please copy and paste it from your PDF viewer for best results.
              </p>
            </div>
        </div>
